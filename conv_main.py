...
from temporal_data import ConvTemporalDataModule
from temporal_data import ConvTemporalDataset
from mvar import conv_mvar
...
def main():
    ...
    data = mvar_trial_generator(
        ...
        noise_level=1e-1,
        model_num = 0)
    data_module = ConvTemporalDataModule(
        data,
        p=p,
        batch_size=10,
        shuffle=True)
    ...
    test_dataloader = DataLoader(
        ConvTemporalDataset(data_test, p),
        batch_size=1,
        shuffle=False)
